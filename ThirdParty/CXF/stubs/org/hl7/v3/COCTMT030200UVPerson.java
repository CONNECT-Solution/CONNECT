...
/**
 * <p>Java class for COCT_MT030200UV.Person complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="COCT_MT030200UV.Person">
 *   &lt;complexContent>
 ...
 *         &lt;element name="asEmployment" type="{urn:hl7-org:v3}COCT_MT030200UV.Employment" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asCitizen" type="{urn:hl7-org:v3}COCT_MT030200UV.Citizen" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asStudent" type="{urn:hl7-org:v3}COCT_MT030200UV.Student" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asMember" type="{urn:hl7-org:v3}COCT_MT030200UV.Member" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asOtherIDs" type="{urn:hl7-org:v3}COCT_MT030200UV.OtherIDs" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asCoveredParty" type="{urn:hl7-org:v3}COCT_MT500000UV.CoveredParty" minOccurs="0"/>
 *         &lt;element name="contactParty" type="{urn:hl7-org:v3}COCT_MT030200UV.ContactParty" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="guardian" type="{urn:hl7-org:v3}COCT_MT030200UV.Guardian" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="guarantor" type="{urn:hl7-org:v3}COCT_MT030200UV.Guarantor" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="birthPlace" type="{urn:hl7-org:v3}COCT_MT030200UV.BirthPlace" minOccurs="0"/>
 *         &lt;element name="languageCommunication" type="{urn:hl7-org:v3}COCT_MT030200UV.LanguageCommunication" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "COCT_MT030200UV.Person", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class COCTMT030200UVPerson {
    ...
    protected List<COCTMT030200UVEmployment> asEmployment;
    @XmlElement(nillable = true)
    protected List<COCTMT030200UVCitizen> asCitizen;
    @XmlElement(nillable = true)
    protected List<COCTMT030200UVStudent> asStudent;
    @XmlElement(nillable = true)
    protected List<COCTMT030200UVMember> asMember;
    @XmlElement(nillable = true)
    protected List<COCTMT030200UVOtherIDs> asOtherIDs;
    @XmlElementRef(name = "asCoveredParty", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<COCTMT500000UVCoveredParty> asCoveredParty;
    @XmlElement(nillable = true)
    protected List<COCTMT030200UVContactParty> contactParty;
    @XmlElement(nillable = true)
    protected List<COCTMT030200UVGuardian> guardian;
    @XmlElement(nillable = true)
    protected List<COCTMT030200UVGuarantor> guarantor;
    @XmlElementRef(name = "birthPlace", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<COCTMT030200UVBirthPlace> birthPlace;
    @XmlElement(nillable = true)
    protected List<COCTMT030200UVLanguageCommunication> languageCommunication;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT030200UVEmployment }
     * 
     * 
     */
    public List<COCTMT030200UVEmployment> getAsEmployment() {
        if (asEmployment == null) {
            asEmployment = new ArrayList<COCTMT030200UVEmployment>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT030200UVCitizen }
     * 
     * 
     */
    public List<COCTMT030200UVCitizen> getAsCitizen() {
        if (asCitizen == null) {
            asCitizen = new ArrayList<COCTMT030200UVCitizen>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT030200UVStudent }
     * 
     * 
     */
    public List<COCTMT030200UVStudent> getAsStudent() {
        if (asStudent == null) {
            asStudent = new ArrayList<COCTMT030200UVStudent>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT030200UVMember }
     * 
     * 
     */
    public List<COCTMT030200UVMember> getAsMember() {
        if (asMember == null) {
            asMember = new ArrayList<COCTMT030200UVMember>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT030200UVOtherIDs }
     * 
     * 
     */
    public List<COCTMT030200UVOtherIDs> getAsOtherIDs() {
        if (asOtherIDs == null) {
            asOtherIDs = new ArrayList<COCTMT030200UVOtherIDs>();
        }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link COCTMT500000UVCoveredParty }{@code >}
     *     
     */
    public JAXBElement<COCTMT500000UVCoveredParty> getAsCoveredParty() {
     ...
     *     
     */
    public void setAsCoveredParty(JAXBElement<COCTMT500000UVCoveredParty> value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT030200UVContactParty }
     * 
     * 
     */
    public List<COCTMT030200UVContactParty> getContactParty() {
        if (contactParty == null) {
            contactParty = new ArrayList<COCTMT030200UVContactParty>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT030200UVGuardian }
     * 
     * 
     */
    public List<COCTMT030200UVGuardian> getGuardian() {
        if (guardian == null) {
            guardian = new ArrayList<COCTMT030200UVGuardian>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT030200UVGuarantor }
     * 
     * 
     */
    public List<COCTMT030200UVGuarantor> getGuarantor() {
        if (guarantor == null) {
            guarantor = new ArrayList<COCTMT030200UVGuarantor>();
        }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link COCTMT030200UVBirthPlace }{@code >}
     *     
     */
    public JAXBElement<COCTMT030200UVBirthPlace> getBirthPlace() {
        return birthPlace;
    }
     ...
     *     
     */
    public void setBirthPlace(JAXBElement<COCTMT030200UVBirthPlace> value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT030200UVLanguageCommunication }
     * 
     * 
     */
    public List<COCTMT030200UVLanguageCommunication> getLanguageCommunication() {
        if (languageCommunication == null) {
            languageCommunication = new ArrayList<COCTMT030200UVLanguageCommunication>();
        }
