...
CREATE TABLE IF NOT EXISTS docrepository.deferredxcarequest (
  ...
  `DeferredResponseEndpoint` varchar(256) NOT NULL COMMENT 'Document Consumer Response Endpoint',
  `DCAdHocQueryRequestId` varchar(45) NOT NULL COMMENT 'Document Consumer Request Id',
