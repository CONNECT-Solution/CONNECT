...
(
	...
	requestKeyGuid VARCHAR(32) NOT NULL COMMENT 'The key that is generated by the producer which must be used to retrieve this document.  This represents a GUID.',
