...
CREATE TABLE IF NOT EXISTS docrepository.deferredxcarequest (
  `AdHocQueryRequestId` varchar(45) NOT NULL COMMENT 'Request Id generated by Initating Gateway ',
  `DeferredResponseEndpoint` varchar(256) NOT NULL COMMENT 'Initiating Gateway Document Consumer Response Endpoint',
  `DCAdHocQueryRequestId` varchar(45) NOT NULL COMMENT 'Document Consumer Requset Id',
  PRIMARY KEY (`AdHocQueryRequestId`));

CREATE TABLE IF NOT EXISTS docrepository.deferredxcaresponse (
  `AdHocQueryRequestId` varchar(45) NOT NULL COMMENT 'Initiating Gateway Request Id',
  `DeferredResponseEndpoint` varchar(256) NOT NULL COMMENT 'Initiating Gateway Deferred Response Endpoint',
  PRIMARY KEY (`AdHocQueryRequestId`));
