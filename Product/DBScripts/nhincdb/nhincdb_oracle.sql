...
--------------------------------------------------------
 ...
 INSERT INTO NHINCUSER.PAGEPREFERENCE
  ...
  INSERT INTO NHINCUSER.PAGEPREFERENCE
   (PREFID, PAGENAME, PAGEDESC, ACCESSPAGE, PREFROLEID)
   VALUES
    (13, 'connectionManager.xhtml', 'Connection Manager', 0, 1);

 INSERT INTO NHINCUSER.PAGEPREFERENCE
   (PREFID, PAGENAME, PAGEDESC, ACCESSPAGE, PREFROLEID)
   VALUES
    (14, 'connectionManager.xhtml', 'Connection Manager', 0, 2);

 INSERT INTO NHINCUSER.PAGEPREFERENCE
   (PREFID, PAGENAME, PAGEDESC, ACCESSPAGE, PREFROLEID)
   VALUES
    (15, 'connectionManager.xhtml', 'Connection Manager', 0, 3);
	
 INSERT INTO NHINCUSER.PAGEPREFERENCE
   (PREFID, PAGENAME, PAGEDESC, ACCESSPAGE, PREFROLEID)
   VALUES
    (16 'properties.xhtml', 'CONNECT Properties', 0, 1);
	
 INSERT INTO NHINCUSER.PAGEPREFERENCE
   (PREFID, PAGENAME, PAGEDESC, ACCESSPAGE, PREFROLEID)
   VALUES
    (17 'properties.xhtml', 'CONNECT Properties', 0, 2);
	
 INSERT INTO NHINCUSER.PAGEPREFERENCE
   (PREFID, PAGENAME, PAGEDESC, ACCESSPAGE, PREFROLEID)
   VALUES
    (18 'properties.xhtml', 'CONNECT Properties', 0, 3);
