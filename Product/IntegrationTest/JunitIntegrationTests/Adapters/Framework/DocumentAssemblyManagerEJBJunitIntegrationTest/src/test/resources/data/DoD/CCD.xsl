...
<xsl:template match="n1:component/n1:structuredBody">
	...
	<xsl:template match="n1:entry">
		<xsl:choose>
			...
			<xsl:when test="n1:act/n1:entryRelationship/n1:observation/n1:code/@code=$loincProblemCode">
...
<!-- 	Superscript or Subscript   -->
	...
	<xsl:template name="documentTitle">
		...
		<xsl:if test="$root/n1:custodian/n1:assignedCustodian/n1:representedCustodianOrganization/n1:name and string-length($root/n1:custodian/n1:assignedCustodian/n1:representedCustodianOrganization/n1:name)>0">
			<xsl:value-of select="$root/n1:custodian/n1:assignedCustodian/n1:representedCustodianOrganization/n1:name"/>
		</xsl:if>

		<xsl:if test="not($root/n1:custodian/n1:assignedCustodian/n1:representedCustodianOrganization/n1:name) or string-length($root/n1:custodian/n1:assignedCustodian/n1:representedCustodianOrganization/n1:name)&lt;1">
