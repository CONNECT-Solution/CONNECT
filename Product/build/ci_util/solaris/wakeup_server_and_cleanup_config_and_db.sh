...
/nhin/soapui-3.5.1/bin/testrunner.sh -Djava.awt.headless=true -f /dev/null /nhin/ValidationSuite/1-InternalSelfTest-soapui-project.xml || true
...
cp /nhin/ValidationSuite/reidentification.xml $AS_HOME/domains/domain1/config/nin
