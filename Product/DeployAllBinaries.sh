...
#
$AS_HOME/bin/asadmin deploy --user admin --passwordfile $HOME/NHINC_Binaries/passfile ~/NHINC_Binaries/MuralMpiEJB.jar 
$AS_HOME/bin/asadmin deploy --user admin --passwordfile $HOME/NHINC_Binaries/passfile ~/NHINC_Binaries/FTATransferAdapterEJB.jar 
...
$AS_HOME/bin/asadmin deploy --user admin --passwordfile $HOME/NHINC_Binaries/passfile ~/NHINC_Binaries/AdapterSubjectDiscoveryEJB.jar 
