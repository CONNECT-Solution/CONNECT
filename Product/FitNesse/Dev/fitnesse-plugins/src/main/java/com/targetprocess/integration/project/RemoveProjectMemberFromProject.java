...
@XmlRootElement(name = "RemoveProjectMemberFromProject")
public class RemoveProjectMemberFromProject {

    protected int projectID;
    protected int projectMemberID;
     ...
     * 
     */
    public void setProjectMemberID(int value) {
