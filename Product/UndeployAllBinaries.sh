...
#
$AS_HOME/bin/asadmin undeploy --user admin --passwordfile $HOME/NHINC_Binaries/passfile ~/NHINC_Binaries/MuralMpiEJB.jar 
$AS_HOME/bin/asadmin undeploy --user admin --passwordfile $HOME/NHINC_Binaries/passfile ~/NHINC_Binaries/FTATransferAdapterEJB.jar 
...
$AS_HOME/bin/asadmin undeploy --user admin --passwordfile $HOME/NHINC_Binaries/passfile ~/NHINC_Binaries/AdapterSubjectDiscoveryEJB.jar 
...
$AS_HOME/bin/asadmin undeploy --user admin --passwordfile $HOME/NHINC_Binaries/passfile ~/NHINC_Binaries/AdapterAuditQueryEJB.jar 
#
# undeploy the Common EJB modules
#
