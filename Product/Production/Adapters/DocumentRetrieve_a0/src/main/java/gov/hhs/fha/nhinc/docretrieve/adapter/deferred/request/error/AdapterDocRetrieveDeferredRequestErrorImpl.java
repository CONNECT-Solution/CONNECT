...
public class AdapterDocRetrieveDeferredRequestErrorImpl {
    public DocRetrieveAcknowledgementType crossGatewayRetrieveRequestError(
            AdapterDocumentRetrieveDeferredRequestErrorSecuredType body, WebServiceContext context) {
        ...
        return new AdapterDocRetrieveDeferredReqErrorOrchImpl().respondingGatewayCrossGatewayRetrieve(request,
                assertion, body.getErrorMsg());
    }

    public DocRetrieveAcknowledgementType crossGatewayRetrieveRequestError(
            AdapterDocumentRetrieveDeferredRequestErrorType body, WebServiceContext context) {
