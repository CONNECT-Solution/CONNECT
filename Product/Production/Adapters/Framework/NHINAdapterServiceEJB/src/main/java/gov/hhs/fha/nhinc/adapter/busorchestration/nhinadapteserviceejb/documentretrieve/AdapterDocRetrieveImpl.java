...
public class AdapterDocRetrieveImpl
{
    ...
    private static AdapterDocRetrieveImpl singlton = null;
    private static Log log = LogFactory.getLog(
            AdapterDocRetrieveImpl.class);


    static
    {
        singlton = new AdapterDocRetrieveImpl();
    }
     ...
     * @return the Singlton
     */
    public static AdapterDocRetrieveImpl getInstance()
    {
        return singlton;
    }
