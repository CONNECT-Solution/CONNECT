...
public class AdapterConstants {
     ...
     */
    public final static String DOCUMENT_ASSEMBLY="urn:gov:hhs:fha:nhinc:services:documentassembly";
    /**
     * Constant for the Document Manager Service Name
     */
    public final static String DOCUMENT_MANAGER="urn:gov:hhs:fha:nhinc:services:documentmanager";
    /**
     * Constant for the Dynamic Document Cache Service Name
     */
    public final static String DYNAMIC_DOCUMENT_CACHE="urn:gov:hhs:fha:nhinc:services:dynamicdocumentcache";
