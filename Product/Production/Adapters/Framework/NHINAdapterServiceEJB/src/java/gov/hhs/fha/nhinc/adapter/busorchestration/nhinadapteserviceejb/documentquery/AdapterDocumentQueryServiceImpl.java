 ...
 */
public class AdapterDocumentQueryServiceImpl
{

    /** The Singleton */
    private static AdapterDocumentQueryServiceImpl singlton = null;

    /** Local Log */
    private static Log log = LogFactory.getLog(
            AdapterDocumentQueryServiceImpl.class);
    ...
    static
    {
        singlton = new AdapterDocumentQueryServiceImpl();
    }

    private AdapterDocumentQueryServiceImpl()
    {
    }
     ...
     * @return
     */
    public static AdapterDocumentQueryServiceImpl getInstance()
    {
        return singlton;
    }

    /**
     * Handle the actual query for documents - This is the core method of the
     * class and coordinates the creation and storeage of dynamic documents.
     *
