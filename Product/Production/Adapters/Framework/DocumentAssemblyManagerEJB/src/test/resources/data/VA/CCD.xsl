        ...
        <tr class="second">
            ...
            <td>
                <div style="overflow:hidden; white-space:nowrap; width:110px;">
                    <xsl:choose>
                        <xsl:when test="string-length($row/n1:substanceAdministration/n1:entryRelationship/n1:observation/n1:value[@xsi:type='CE']/n1:originalText)=0">
                            <xsl:text>-</xsl:text>
                        </xsl:when>
                        <xsl:otherwise>
...
-->
        ...
        <tr class="second">
            ...
            <td>
                <div style="overflow:hidden; white-space:nowrap; width:360px;">
                    <xsl:variable name="probReference" select="substring-after($rowData/n1:text/n1:reference/@value,'#')"/>
    ...
    <xsl:template name="allergyRow">
        ...
        <tr class="second">
            ...
            <td style="overflow:hidden; white-space:nowrap;">
                <xsl:choose>
                    <xsl:when test="string-length($observation/n1:code/n1:originalText)=0">
                        <xsl:text>Not Available</xsl:text>
                    </xsl:when>
