...
public class PropertiesDAOTest {
   ...
   public void testGetAttributeValue() {
      ...
      String expResult = "http://208.75.163.55:8080/CommonDataLayerService/AdapterCommonDataLayer";
   ...
   public void testGetDASAttribute() {
      ...
      System.out.println(result);
      assertEquals("http://208.75.163.55:8080/CommonDataLayerService/AdapterCommonDataLayer", result.getAttValue());
   }
}