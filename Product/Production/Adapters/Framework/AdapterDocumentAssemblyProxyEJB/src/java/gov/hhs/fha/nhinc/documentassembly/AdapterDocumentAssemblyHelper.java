...
public class AdapterDocumentAssemblyHelper {
   ...
   private static AssertionType createAssertion() {
      AssertionType assertion = new AssertionType();

      return assertion;
   }

   private Object getPatientObject(POCDMT000040RecordTarget target) {
      POCDMT000040PatientRole ptRole = target.getPatientRole();
      if (ptRole != null) {
         POCDMT000040Patient patient = ptRole.getPatient();
         List<PNExplicit> namesList = patient.getName();
   ...
   private String toPrettyXML(
           ProvideAndRegisterDocumentSetRequestType pObject) throws JAXBException {
      ObjectFactory factory = new ObjectFactory();
      JAXBContext jc = JAXBContext.newInstance("ihe.iti.xds_b._2007");
      Marshaller marshaller = jc.createMarshaller();
      nu.xom.Document xmlDocument = XOMUtil.jaxbMarshal(marshaller, factory.createProvideAndRegisterDocumentSetRequest(pObject));
