...
public class DocRetrieveResponseProcessorTest {
    ...
    public void testFilterResultsNullInputs() {
        ...
        assertNull("RetrieveDocumentSetResponseType was null", response);
        adhocQueryResponse = new RetrieveDocumentSetResponseType();
        response = testFilterResults(adhocQueryResponse, null);
        assertNull("RetrieveDocumentSetResponseType was null", response);
        ...
        response = testFilterResults(adhocQueryResponse, patientPreferences1);
        assertNull("RetrieveDocumentSetResponseType was null", response);
    ...
    public void testFilterResultsHappy() {
        ...
        assertNull("RetrieveDocumentSetResponseType was null", response);
        RetrieveDocumentSetResponseType retrieveDocSetResponse1 = new RetrieveDocumentSetResponseType();
        DocumentResponse aDocResponse = new DocumentResponse();
        createDocumentResponse(aDocResponse);
        retrieveDocSetResponse1.getDocumentResponse().add(aDocResponse);
        PatientPreferencesType patientPreferences1 = new PatientPreferencesType();
        patientPreferences1.setAssigningAuthority("1.1.1");
        patientPreferences1.setPatientId("D123401");
        response = testFilterResults(retrieveDocSetResponse1, patientPreferences);
        assertNull("RetrieveDocumentSetResponseType was not null", response);
    }
    ...
    public void testFilterResultsMoreHappy() {
        ...
        DocRetrieveResponseProcessor processor = new DocRetrieveResponseProcessor() {
            ...
            assertTrue("All Values Set expecting a non null response",processor.filterResults(aDocResponse, patientPreferences));
    }
    ...
    private RetrieveDocumentSetResponseType testFilterResults(RetrieveDocumentSetResponseType retrieveResponse, PatientPreferencesType patientPreferences) {
        ...
        try {
            ...
            if (processor.filterResults(docResponse, patientPreferences)) {
    ...
    public void testExtractDocTypeFromMetaData() {
        ...
        sIntStrType.getLocalizedString().add(l);
        l.setValue("Summerization Of Epizode");
        oClassification.setName(sIntStrType);
        ...
        InternationalStringType sIntStrType1 = new InternationalStringType();
        LocalizedStringType l1 = new LocalizedStringType();
        sIntStrType.getLocalizedString().add(l1);
        l1.setValue("Summerization Of Epizode");
        oClassification.setName(sIntStrType1);
