 ...
 * @author westbergl
 */
@WebService(serviceName = "AdapterPIP", portName = "AdapterPIPPortSoap11", endpointInterface = "gov.hhs.fha.nhinc.adapterpip.AdapterPIPPortType", targetNamespace = "urn:gov:hhs:fha:nhinc:adapterpip", wsdlLocation = "META-INF/wsdl/AdapterPIPService/AdapterPIP.wsdl")
@Stateless
public class AdapterPIPService implements AdapterPIPPortType {
