...
import org.hl7.v3.PIXConsumerPRPAIN201305UVProxyRequestType;
import org.hl7.v3.PIXConsumerPRPAIN201305UVProxySecuredRequestType;
...
public class NhincProxyPatientDiscoveryImpl {
    ...
    public PRPAIN201306UV02 pixConsumerPRPAIN201305UV(PIXConsumerPRPAIN201305UVProxyRequestType request) {
        ...
        try {
            ...
            PIXConsumerPRPAIN201305UVProxySecuredRequestType body = new PIXConsumerPRPAIN201305UVProxySecuredRequestType();
            body.setPRPAIN201305UV02(request.getPRPAIN201305UV02());
            body.setNhinTargetSystem(request.getNhinTargetSystem());
            response = port.pixConsumerPRPAIN201305UV(body);
        }
        catch (Exception ex) {
