 ...
 * <bean id="entitypatientdiscoveryasyncresp" class="gov.hhs.fha.nhinc.entity.patientdiscovery.async.response.proxy.EntityPatientDiscoveryAsyncRespNoOpImpl"/>
 * the bean id is "entitypatientdiscoveryasyncresp" and an object of this type can be retrieved from
 * the application context by calling the getBean method like:
 * context.getBean("entitypatientdiscoveryasyncresp");. This returns an object that can be casted to
 * the appropriate interface and then used in the application code. See the
 * getEntityPatientDisocoveryAsyncRespProxy() method in this class.
 *
 * @author Jon Hoppesch
 */
public class EntityPatientDiscoveryAsyncRespProxyObjectFactory {
    private static final String CONFIG_FILE_NAME = "EntityPatientDiscoveryAsyncRespProxyConfig.xml";
    private static final String BEAN_NAME_PATIENT_DISCOVERY = "entitypatientdiscoveryasyncresp";
     ...
     * identifier of "entitypatientdiscoveryasyncresp."
     *
     * @return EntityPatientDiscoveryAsyncRespProxy instance
     */
    public EntityPatientDiscoveryAsyncRespProxy getEntityPatientDiscoveryAsyncRespProxy() {
        EntityPatientDiscoveryAsyncRespProxy entityPatientDiscoveryAsyncResp = null;
        if (context != null) {
            entityPatientDiscoveryAsyncResp = (EntityPatientDiscoveryAsyncRespProxy) context.getBean(BEAN_NAME_PATIENT_DISCOVERY);
        }
        return entityPatientDiscoveryAsyncResp;
    }
