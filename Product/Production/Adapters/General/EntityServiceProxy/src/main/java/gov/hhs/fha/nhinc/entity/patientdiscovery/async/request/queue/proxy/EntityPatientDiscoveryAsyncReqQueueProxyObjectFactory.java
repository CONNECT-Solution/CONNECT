 ...
 * <bean id="entitypatientdiscoveryasyncreqqueue" class="gov.hhs.fha.nhinc.entity.patientdiscovery.async.req.queue.proxy.EntityPatientDiscoveryAsyncReqQueueNoOpImpl"/>
 * the bean id is "entitypatientdiscoveryasyncreqqueue" and an object of this type can be retrieved from
 * the application context by calling the getBean method like:
 * context.getBean("entitypatientdiscoveryasyncreqqueue");. This returns an object that can be casted to
 * the appropriate interface and then used in the application code. See the
 * getEntityPatientDisocoveryAsyncReqQueueProxy() method in this class.
 *
 * @author Jon Hoppesch
 */
public class EntityPatientDiscoveryAsyncReqQueueProxyObjectFactory {
    private static final String CONFIG_FILE_NAME = "EntityPatientDiscoveryAsyncReqQueueProxyConfig.xml";
    private static final String BEAN_NAME_PATIENT_DISCOVERY = "entitypatientdiscoveryasyncreqqueue";
     ...
     * identifier of "entitypatientdiscoveryasyncreqqueue."
     *
     * @return EntityPatientDiscoveryAsyncReqQueueProxy instance
     */
    public EntityPatientDiscoveryAsyncReqQueueProxy getEntityPatientDiscoveryAsyncReqQueueProxy() {
        EntityPatientDiscoveryAsyncReqQueueProxy entityPatientDiscoveryAsyncReqQueue = null;
        if (context != null) {
            entityPatientDiscoveryAsyncReqQueue = (EntityPatientDiscoveryAsyncReqQueueProxy) context.getBean(BEAN_NAME_PATIENT_DISCOVERY);
        }
        return entityPatientDiscoveryAsyncReqQueue;
    }
}
