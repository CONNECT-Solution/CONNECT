 ...
 * @author Jon Hoppesch
 */
public class PassthruPatientDiscoveryAsyncRespProxyObjectFactory {
    private static final String CONFIG_FILE_NAME = "PassthruPatientDiscoveryAsyncRespProxyConfig.xml";
    private static final String BEAN_NAME_PATIENT_DISCOVERY = "passthrupatientdiscoveryasyncresp";
     ...
     */
    public PassthruPatientDiscoveryAsyncRespProxy getPassthruPatientDiscoveryAsyncRespProxy() {
        PassthruPatientDiscoveryAsyncRespProxy passthruPatientDiscoveryAsyncResp = null;
        if (context != null) {
            passthruPatientDiscoveryAsyncResp = (PassthruPatientDiscoveryAsyncRespProxy) context.getBean(BEAN_NAME_PATIENT_DISCOVERY);
        }
        return passthruPatientDiscoveryAsyncResp;
    }
