...
public class AdapterPIPProxyObjectFactoryConcreteJavaTest
{
    ...
    public AdapterPIPProxyObjectFactoryConcreteJavaTest()
    {
    }
    ...
    public void testAdapterPIPProxyObjectFactory()
    {
        ...
        try
        {
            ...
            assertTrue("Adapter PIP was not the Java concrete type.", (oAdapterPIPProxy instanceof AdapterPIPJavaProxy));
