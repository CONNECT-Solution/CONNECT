package gov.hhs.fha.nhinc.adapters.general.adapterpolicyenginetransformejb.adapterpolicyenginetransform;

import gov.hhs.fha.nhinc.adapterpolicyenginetransform.AdapterPolicyEngineTransformPortType;
...
/**
 * This is used to do some of the transforms of messages for the Policy Engine.  They
 * were getting too complex to do in BPEL and this seemed like a much better place to do these.
 * 
 * @author Les Westberg
 * 
 */
@WebService(serviceName = "AdapterPolicyEngineTransform", 
            portName = "AdapterPolicyEngineTransformPortSoap11", 
             endpointInterface = "gov.hhs.fha.nhinc.adapterpolicyenginetransform.AdapterPolicyEngineTransformPortType", 
             targetNamespace = "urn:gov:hhs:fha:nhinc:adapterpolicyenginetransform", 
             wsdlLocation = "META-INF/wsdl/AdapterPolicyEngineTransform/AdapterPolicyEngineTransform.wsdl")
@Stateless
public class AdapterPolicyEngineTransform implements AdapterPolicyEngineTransformPortType
{
