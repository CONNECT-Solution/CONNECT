 ...
 * @author shawc
 */
@WebService(serviceName = "DocumentRepository_Service", portName = "DocumentRepository_Port_Soap", endpointInterface = "ihe.iti.xds_b._2007.DocumentRepositoryPortType", targetNamespace = "urn:ihe:iti:xds-b:2007", wsdlLocation = "META-INF/wsdl/AdapterDocRepository2Soap12Service/AdapterComponentDocRepository.wsdl")
@Stateless
