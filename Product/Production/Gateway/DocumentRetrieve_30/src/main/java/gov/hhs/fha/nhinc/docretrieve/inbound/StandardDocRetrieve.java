 ...
 */
public class StandardDocRetrieve implements DocRetrieveService {
    ...
    public RetrieveDocumentSetResponseType respondingGatewayCrossGatewayRetrieve(RetrieveDocumentSetRequestType body,
        ...
        InboundDocRetrieveOrchestratable message = new InboundStandardDocRetrieveOrchestratable(pt, at, ad);
