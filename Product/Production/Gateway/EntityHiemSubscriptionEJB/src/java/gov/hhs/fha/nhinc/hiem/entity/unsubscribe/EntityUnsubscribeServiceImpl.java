...
public class EntityUnsubscribeServiceImpl
{
    ...
    private void unsubscribeToChild(Unsubscribe parentUnsubscribe, SubscriptionItem childSubscriptionItem, AssertionType parentAssertion) throws UnableToDestroySubscriptionFault, ResourceUnknownFault
    {
        try
        {
            log.debug("unsubscribing to child subscription");
