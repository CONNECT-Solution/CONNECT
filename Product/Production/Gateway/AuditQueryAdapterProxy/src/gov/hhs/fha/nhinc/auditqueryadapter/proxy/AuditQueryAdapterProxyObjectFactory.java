 ...
 */
package gov.hhs.fha.nhinc.auditqueryadapter.proxy;
 ...
 * <bean id="adapterauditquery" class="gov.hhs.fha.nhinc.adapterauditquery.proxy.AdapterAuditQueryNoOpImpl"/>
 ...
 * @author Jon Hoppesch
 */
public class AuditQueryAdapterProxyObjectFactory {

    private static final String CONFIG_FILE_NAME = "AdapterAuditQueryProxyConfig.xml";
    private static final String BEAN_NAME_AUDIT_REPOSITORY = "adapterauditquery";
     ...
     *
     * @return AuditQueryAdapterProxy instance
     */
    public AuditQueryAdapterProxy getAdapterAuditQueryProxy() {
        AuditQueryAdapterProxy adapterAuditQuery = null;
        if (context != null) {
            adapterAuditQuery = (AuditQueryAdapterProxy) context.getBean(BEAN_NAME_AUDIT_REPOSITORY);
        }
        return adapterAuditQuery;
    }
}
