 ...
 * <bean id="nhinpatientdiscoveryasyncresp" class="gov.hhs.fha.nhinc.nhinpatientdiscovery.async.response.proxy.NhinPatientDiscoveryAsyncRespNoOpImpl"/>
 * the bean id is "nhinpatientdiscoveryasyncresp" and an object of this type can be retrieved from
 * the application context by calling the getBean method like:
 * context.getBean("nhinpatientdiscoveryasyncresp");. This returns an object that can be casted to
 * the appropriate interface and then used in the application code. See the
 * getNhinPatientDisocoveryAsyncRespProxy() method in this class.
 *
 * @author Jon Hoppesch
 */
public class NhinPatientDiscoveryAsyncRespProxyObjectFactory {
    private static final String CONFIG_FILE_NAME = "NhinPatientDiscoveryAsyncRespProxyConfig.xml";
    private static final String BEAN_NAME_PATIENT_DISCOVERY = "nhinpatientdiscoveryasyncresp";
     ...
     * identifier of "nhinpatientdiscoveryasyncresp."
     *
     * @return NhinPatientDiscoveryAsyncRespProxy instance
     */
    public NhinPatientDiscoveryAsyncRespProxy getNhinPatientDiscoveryAsyncRespProxy() {
        NhinPatientDiscoveryAsyncRespProxy nhinPatientDiscoveryAsyncResp = null;
        if (context != null) {
            nhinPatientDiscoveryAsyncResp = (NhinPatientDiscoveryAsyncRespProxy) context.getBean(BEAN_NAME_PATIENT_DISCOVERY);
        }
        return nhinPatientDiscoveryAsyncResp;
    }
