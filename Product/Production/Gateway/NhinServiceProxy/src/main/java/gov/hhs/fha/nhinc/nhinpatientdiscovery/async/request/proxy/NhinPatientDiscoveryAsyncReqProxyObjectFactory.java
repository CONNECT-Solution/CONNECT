 ...
 * <bean id="nhinpatientdiscoveryasyncreq" class="gov.hhs.fha.nhinc.nhinpatientdiscovery.async.request.proxy.NhinPatientDiscoveryAsyncReqNoOpImpl"/>
 * the bean id is "nhinpatientdiscoveryasyncreq" and an object of this type can be retrieved from
 * the application context by calling the getBean method like:
 * context.getBean("nhinpatientdiscoveryasyncreq");. This returns an object that can be casted to
 * the appropriate interface and then used in the application code. See the
 * getNhinPatientDisocoveryAsyncReqProxy() method in this class.
 *
 * @author Jon Hoppesch
 */
public class NhinPatientDiscoveryAsyncReqProxyObjectFactory {
    private static final String CONFIG_FILE_NAME = "NhinPatientDiscoveryAsyncReqProxyConfig.xml";
    private static final String BEAN_NAME_PATIENT_DISCOVERY = "nhinpatientdiscoveryasyncreq";
     ...
     * identifier of "nhinpatientdiscoveryasyncreq."
     *
     * @return NhinPatientDiscoveryAsyncReqProxy instance
     */
    public NhinPatientDiscoveryAsyncReqProxy getNhinPatientDiscoveryAsyncReqProxy() {
        NhinPatientDiscoveryAsyncReqProxy nhinPatientDiscoveryAsyncReq = null;
        if (context != null) {
            nhinPatientDiscoveryAsyncReq = (NhinPatientDiscoveryAsyncReqProxy) context.getBean(BEAN_NAME_PATIENT_DISCOVERY);
        }
        return nhinPatientDiscoveryAsyncReq;
    }
