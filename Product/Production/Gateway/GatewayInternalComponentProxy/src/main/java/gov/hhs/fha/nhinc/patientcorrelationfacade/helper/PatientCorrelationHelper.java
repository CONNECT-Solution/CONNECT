...
public class PatientCorrelationHelper
{
    ...
    public org.hl7.v3.PRPAIN201310UV02 retrievePatientCorrelations(org.hl7.v3.PRPAIN201309UV02 correlationInput, AssertionType assertion)
    {
        ...
        { // Call Web Service Operation
            ...
            org.hl7.v3.RetrievePatientCorrelationsResponseType result = null;
        ...
        if (retryCount > 0 && retryDelay > 0 && exceptionText != null && !exceptionText.equalsIgnoreCase("")) {
                ...
                try {
                    ...
                    if (flag == 1) {
                        ...
                        try {
                            ...
                            log.error("Thread Got Interrupted while waiting on patientcorrelation call :" + iEx);
                        } catch (IllegalArgumentException iaEx) {
                            log.error("Thread Got Interrupted while waiting on patientcorrelation call :" + iaEx);
                        }
                        retryDelay = retryDelay + retryDelay; //This is a requirement from Customer
                    } else {
                        log.error("Unable to call patientcorrelation Webservice due to  : " + e);
                        throw e;
                    }
                }
            }
            ...
            if (i > retryCount) {
                log.error("Unable to call patientcorrelation Webservice due to  : " + catchExp);
                throw catchExp;
            }
    ...
    public org.hl7.v3.MCCIIN000002UV01 addPatientCorrelation(org.hl7.v3.PRPAIN201301UV02 request, AssertionType assertion)
    {
        ...
        { // Call Web Service Operation
            ...
            org.hl7.v3.AddPatientCorrelationResponseType result = null;
