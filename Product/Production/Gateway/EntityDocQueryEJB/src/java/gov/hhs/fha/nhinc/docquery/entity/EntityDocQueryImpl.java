...
public class EntityDocQueryImpl {
    ...
    private static Log log = LogFactory.getLog(EntityDocQueryImpl.class);
    private String localHomeCommunity = null;

    /**
     * This method will perform a document query to a specified set of target communities and
     * aggregate the results from each community that match the specified search criteria into one List.
     * This combined list of documents will be returned to the user.
     *
     ...
     */
    public AdhocQueryResponse documentQuery(RespondingGatewayCrossGatewayQueryRequestType request) {
        ...
        if (request.getAdhocQueryRequest() != null &&
            ...
            if (correlationsResult != null &&
                ...
                for (QualifiedSubjectIdentifierType subId : correlationsResult.getQualifiedPatientIdentifier()) {
                    ...
                    docQuery.setAssertion(request.getAssertion());
