...
public class HibernateUtil 
{
    ...
    private static File getConfigFile(){
        ...
        try
        {
            result = HibernateAccessor.getHibernateFile(NhincConstants.HIBERNATE_SUBSCRIPTION_REPOSITORY);
        }
        catch (Exception ex)
        {
            log.error("Unable to load " + NhincConstants.HIBERNATE_SUBSCRIPTION_REPOSITORY + " " + ex.getMessage(), ex );
        }
