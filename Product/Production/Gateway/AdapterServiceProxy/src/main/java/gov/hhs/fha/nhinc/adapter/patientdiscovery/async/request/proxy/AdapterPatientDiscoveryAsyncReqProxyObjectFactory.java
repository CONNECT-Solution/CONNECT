 ...
 * <bean id="adapterpatientdiscoveryasyncreq" class="gov.hhs.fha.nhinc.adapter.patientdiscovery.async.req.proxy.AdapterPatientDiscoveryAsyncReqNoOpImpl"/>
 * the bean id is "adapterpatientdiscoveryasyncreq" and an object of this type can be retrieved from
 * the application context by calling the getBean method like:
 * context.getBean("adapterpatientdiscoveryasyncreq");. This returns an object that can be casted to
 * the appropriate interface and then used in the application code. See the
 * getAdapterPatientDisocoveryAsyncReqProxy() method in this class.
 *
 * @author Jon Hoppesch
 */
public class AdapterPatientDiscoveryAsyncReqProxyObjectFactory {
    private static final String CONFIG_FILE_NAME = "AdapterPatientDiscoveryAsyncReqProxyConfig.xml";
    private static final String BEAN_NAME_PATIENT_DISCOVERY = "adapterpatientdiscoveryasyncreq";
     ...
     * identifier of "adapterpatientdiscoveryasyncreq."
     *
     * @return AdapterPatientDiscoveryAsyncReqProxy instance
     */
    public AdapterPatientDiscoveryAsyncReqProxy getAdapterPatientDiscoveryAsyncReqProxy() {
        AdapterPatientDiscoveryAsyncReqProxy adapterPatientDiscoveryAsyncReq = null;
        if (context != null) {
            adapterPatientDiscoveryAsyncReq = (AdapterPatientDiscoveryAsyncReqProxy) context.getBean(BEAN_NAME_PATIENT_DISCOVERY);
        }
        return adapterPatientDiscoveryAsyncReq;
    }
