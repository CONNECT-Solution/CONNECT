...
public class NotificationMessageSender
{
    ...
    public void sendNotify(NotificationMessageHolderType notifyMessage, AssertionType assertion, String endpointAddress)
    {
        ...
        if (retryCount > 0 && retryDelay > 0 && exceptionText != null && !exceptionText.equalsIgnoreCase("")) {
                ...
                try {
                    ...
                    if (flag == 1) {
                        ...
                        try {
                            ...
                            log.error("Thread Got Interrupted while waiting on NotificationMessageSender call :" + iEx);
                        } catch (IllegalArgumentException iaEx) {
                            log.error("Thread Got Interrupted while waiting on NotificationMessageSender call :" + iaEx);
                        }
                        retryDelay = retryDelay + retryDelay; //This is a requirement from Customer
                    } else {
                        log.error("Unable to call NotificationMessageSender Webservice due to  : " + e);
                        throw e;
                    }
                }
            }
            ...
            if (i > retryCount) {
                log.error("Unable to call NotificationMessageSender Webservice due to  : " + catchExp);
                throw catchExp;
            }
