 ...
 * @author JHOPPESC
 */
public class EntityPatientDiscoverySecuredAsyncReqImplTest {

    public EntityPatientDiscoverySecuredAsyncReqImplTest() {
    }
    ...
    /**
     * Test of processPatientDiscoveryAsyncReq method, of class EntityPatientDiscoverySecuredAsyncReqImpl.
     */
    @Test
    public void testProcessPatientDiscoveryAsyncReq() {
        System.out.println("testProcessPatientDiscoveryAsyncReq");

        EntityPatientDiscoverySecuredAsyncReqImpl instance = new EntityPatientDiscoverySecuredAsyncReqImpl() {
            @Override
