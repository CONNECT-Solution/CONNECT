...
import gov.hhs.fha.nhinc.nhinccomponentaggregator.NhincComponentAggregatorPortType;
 ...
 * @author westbergl
 */
@WebService(serviceName = "NhincComponentAggregator", 
            portName = "NhincComponentAggregatorPort", 
            endpointInterface = "gov.hhs.fha.nhinc.nhinccomponentaggregator.NhincComponentAggregatorPortType", 
            targetNamespace = "urn:gov:hhs:fha:nhinc:nhinccomponentaggregator", 
            wsdlLocation = "META-INF/wsdl/NhincComponentAggregator/NhincComponentAggregator.wsdl")
@Stateless
public class NhincComponentAggregator implements NhincComponentAggregatorPortType
{
