...
public class AdapterDocQueryDeferredResponseProxyWebServiceUnsecuredImpl implements AdapterDocQueryDeferredResponseProxy {
    ...
    protected String getEndpointURL()
    {
        ...
        String serviceName = NhincConstants.ADAPTER_DOCUMENT_QUERY_DEFERRED_RESP_SERVICE_NAME;
        try
        {
    ...
    public DocQueryAcknowledgementType respondingGatewayCrossGatewayQuery(AdhocQueryResponse msg, AssertionType assertion, NhinTargetCommunitiesType targets) {
        ...
        try
        {
            ...
            else
            {
                ...
                response = (DocQueryAcknowledgementType)oProxyHelper.invokePort(port, AdapterDocQueryDeferredResponsePortType.class, "respondingGatewayCrossGatewayQuery", msg);
            }
        }
        catch (Exception ex)
        {
