...
public class EntityDocRetrieveOrchestrationContextBuilder_g0 implements OrchestrationContextBuilder {
    ...
    public OrchestrationContext build() {
        return new OrchestrationContext(new NhinDocRetrieveStrategyImpl_g0(), new EntityDocRetrieveOrchestratableImpl_a0(getRetrieveDocumentSetRequestType(), getAssertionType(), getPolicyTransformer(), getAuditTransformer(), getNhinDelegate(), getNhinAggregator(), getTarget()));
    }
