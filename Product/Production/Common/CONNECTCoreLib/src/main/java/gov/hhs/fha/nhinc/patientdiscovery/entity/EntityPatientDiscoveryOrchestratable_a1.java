...
/**
 * EntityPatientDiscoveryOrchestratable_a1 returns the response for the a1 specification
 ...
 * @author paul.eftis
 */
public class EntityPatientDiscoveryOrchestratable_a1
    ...
    public EntityPatientDiscoveryOrchestratable_a1(){
        super();
    }
    

    public EntityPatientDiscoveryOrchestratable_a1(NhinDelegate d, NhinResponseProcessor p,
