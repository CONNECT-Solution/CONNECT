...
public class AdapterComponentDocRegistryProxyWebServiceUnsecuredImpl implements AdapterComponentDocRegistryProxy
{
     ...
     */
    protected DocumentRegistryPortType getPort(String url, String wsAddressingAction)
    {
     ...
     */
    public AdhocQueryResponse registryStoredQuery(AdhocQueryRequest msg) {
        ...
        try
        {
            ...
            DocumentRegistryPortType port = getPort(url, WS_ADDRESSING_ACTION);
