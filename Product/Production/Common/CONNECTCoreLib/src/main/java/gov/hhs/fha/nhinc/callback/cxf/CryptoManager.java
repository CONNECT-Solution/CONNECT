...
public class CryptoManager implements Crypto {
    ...
    /* (non-Javadoc)
     * @see org.apache.ws.security.components.crypto.Crypto#getBytesFromCertificates(java.security.cert.X509Certificate[])
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.ws.security.components.crypto.Crypto#getPrivateKey(java.security.cert.X509Certificate, javax.security.auth.callback.CallbackHandler)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.ws.security.components.crypto.Crypto#getX509Certificates(org.apache.ws.security.components.crypto.CryptoType)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apache.ws.security.components.crypto.Crypto#setCertificateFactory(java.lang.String, java.security.cert.CertificateFactory)
     */
    @Override
