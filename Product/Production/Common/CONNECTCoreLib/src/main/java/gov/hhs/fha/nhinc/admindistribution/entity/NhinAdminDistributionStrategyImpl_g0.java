 ...
 * @author nnguyen
 */
public class NhinAdminDistributionStrategyImpl_g0 implements OrchestrationStrategy {

    private static Log log = LogFactory.getLog(NhinAdminDistributionStrategyImpl_g0.class);

    public NhinAdminDistributionStrategyImpl_g0() {
    }
    ...
    public void execute(EntityAdminDistributionOrchestratable message) {
        ...
        if (message instanceof EntityAdminDistributionOrchestratableImpl_a0) {
