 ...
 * @author nnguyen
 */
public class EntityAdminDistributionOrchestrationContextBuilder_g1 implements OrchestrationContextBuilder {
    ...
    public OrchestrationContext build() {
        ...
        return new OrchestrationContext(new NhinAdminDistributionStrategyImpl_g1(),
                new EntityAdminDistributionOrchestratableImpl_a1(
