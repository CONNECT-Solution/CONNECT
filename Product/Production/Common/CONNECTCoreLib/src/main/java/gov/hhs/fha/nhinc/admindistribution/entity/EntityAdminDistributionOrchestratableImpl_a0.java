 ...
 * @author nnguyen
 */
public class EntityAdminDistributionOrchestratableImpl_a0 extends EntityAdminDistributionOrchestratable {

    public EntityAdminDistributionOrchestratableImpl_a0(RespondingGatewaySendAlertMessageType request,
