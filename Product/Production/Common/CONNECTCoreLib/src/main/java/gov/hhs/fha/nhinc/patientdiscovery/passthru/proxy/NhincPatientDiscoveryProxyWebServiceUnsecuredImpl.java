 ...
 * @author jhoppesc
 */
public class NhincPatientDiscoveryProxyWebServiceUnsecuredImpl implements NhincPatientDiscoveryProxy {
     ...
     * Default constructor.
     */
    public NhincPatientDiscoveryProxyWebServiceUnsecuredImpl()
    {
        log = createLogger();
    }
