...
public class AdapterDocQueryDeferredResponseProxyWebServiceSecuredImpl implements AdapterDocQueryDeferredResponseProxy {
    ...
    private static final String WS_ADDRESSING_ACTION = "urn:gov:hhs:fha:nhinc:adapterDocQueryDeferredResponseSecured:RespondingGateway_CrossGatewayQueryRequestMessage";
    ...
    protected String getEndpointURL()
    {
        ...
        String serviceName = NhincConstants.ADAPTER_DOCUMENT_QUERY_DEFERRED_RESP_SECURED_SERVICE_NAME;
        try
        {
