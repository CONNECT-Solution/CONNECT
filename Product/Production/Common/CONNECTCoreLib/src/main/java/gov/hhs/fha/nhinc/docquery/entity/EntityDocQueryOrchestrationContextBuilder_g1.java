...
/**
 * Builds the DocQuery OrchestrationContext for g1 endpoint
 * @author paul.eftis
 */
public class EntityDocQueryOrchestrationContextBuilder_g1 implements OrchestrationContextBuilder{
	...
	public OrchestrationContext build(){
            EntityDocQueryOrchestratable_a1 orch_a1 =
                    new EntityDocQueryOrchestratable_a1(
                        getNhinDelegate(), getProcessor(), getAuditTransformer(),
                        getPolicyTransformer(), getAssertionType(), getServiceName(),
                        getTarget(), getRequest());
            return new OrchestrationContext(new NhinDocQueryStrategyImpl_g1(), orch_a1);
	}	
