 ...
 * @author Les Westberg
 */
public class NhincPatientDiscoveryProxyObjectFactory extends ComponentProxyObjectFactory {
     ...
     * @return An instance of the NhinPatientDiscoveryProxy class.
     */
    public NhincPatientDiscoveryProxy getNhincPatientDiscoveryProxy() {

        return getBean(BEAN_NAME_PATIENT_DISCOVERY, NhincPatientDiscoveryProxy.class);
    }
}
