...
public class EntityDocQueryProcessorHelper{
    ...
    public static EntityDocQueryOrchestratable_a0 createNewCumulativeResponse_a0(
        ...
        log.debug("EntityDocQueryProcessorHelper constructed initial cumulativeResponse");
    ...
    public static EntityDocQueryOrchestratable_a0 transformResponse_a0(
        ...
        // EntityDocQueryOrchestratable_a1 original_a1 = (EntityDocQueryOrchestratable_a0)original;
    ...
    public static EntityDocQueryOrchestratable_a0 transformResponse_a1(
            EntityDocQueryOrchestratable original){

        // currently a0 is same as a1
        EntityDocQueryOrchestratable_a0 response_a1 = new EntityDocQueryOrchestratable_a0();
        EntityDocQueryOrchestratable_a0 original_a0 = (EntityDocQueryOrchestratable_a0)original;
