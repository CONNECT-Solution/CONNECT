 ...
 * @author mflynn02
 */
public class NhincPatientDiscoveryProxyWebServiceSecuredImpl implements NhincPatientDiscoveryProxy {
    ...
    public NhincPatientDiscoveryProxyWebServiceSecuredImpl()
    {
        log = createLogger();
    }
