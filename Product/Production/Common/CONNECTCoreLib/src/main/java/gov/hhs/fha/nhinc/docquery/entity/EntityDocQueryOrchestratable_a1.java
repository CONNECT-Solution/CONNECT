...
/**
 * EntityDocQueryOrchestratable_a1 returns the response for the a1 specification
 ...
 * @author paul.eftis
 */
public class EntityDocQueryOrchestratable_a1
    ...
    public EntityDocQueryOrchestratable_a1(){
        super();
    }
    

    public EntityDocQueryOrchestratable_a1(NhinDelegate d, NhinResponseProcessor p,
