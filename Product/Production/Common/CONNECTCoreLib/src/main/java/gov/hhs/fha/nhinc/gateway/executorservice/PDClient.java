 ...
 * Target is a gov.hhs.fha.nhinc.connectmgr.data.CMUrlInfo object
 ...
 * @author paul.eftis
 */
public class PDClient<Target extends CMUrlInfo, Request extends RespondingGatewayPRPAIN201305UV02RequestType,
     ...
     * InitServlet.getTimeoutValues().get("DQRequestTimeout"))
      *
     * @param t is CMUrlInfo target with url to call
