 ...
 * @author Les Westberg
 */
public class AdapterPolicyEngineDenyNoOpImpl implements AdapterPolicyEngineProxy
{

    /**
     * Given a request to check the access policy, this service will always return
     * a deny response.
     *
