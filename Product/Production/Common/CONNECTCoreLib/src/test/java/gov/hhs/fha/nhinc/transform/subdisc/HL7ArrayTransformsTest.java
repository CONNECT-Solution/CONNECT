...
public class HL7ArrayTransformsTest {
    ...
    public void testCopyNullFlavorsWhenFromRequestNullFlavorNull() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        PRPAIN201301UV02 returnedToRequest = trans.copyNullFlavors(createPRPAIN201305UV02Null(), createPRPAIN201301UV02());
    ...
    public void testCopyNullFlavorsPNExplicit() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        ENExplicit returnedToRequest = trans.copyNullFlavors(createPNExplicitFromRequest(), createENExplicitToRequest());
        assertEquals(returnedToRequest.getNullFlavor().get(0), "NA");
        assertEquals(returnedToRequest.getNullFlavor().get(1), "NATest");
    }
    ...
    public void testCopyNullFlavorsPNExplicitEmpty() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        ENExplicit returnedToRequest = trans.copyNullFlavors(createPNExplicitFromRequestEmpty(), createENExplicitToRequest());
    ...
    public void testCopyNullFlavorsENExplicit() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        PNExplicit returnedToRequest = trans.copyNullFlavors(createENExplicitFromRequest(), createPNExplicitToRequest());
        assertEquals(returnedToRequest.getNullFlavor().get(0), "NA");
        assertEquals(returnedToRequest.getNullFlavor().get(1), "NATest");
    }
    ...
    public void testCopyNullFlavorsENExplicitEmpty() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        PNExplicit returnedToRequest = trans.copyNullFlavors(createENExplicitFromRequestEmpty(), createPNExplicitToRequest());
        assertEquals(returnedToRequest.getNullFlavor().get(0), "NAPNExplicit");
    }
    ...
    public void testCopyNullFlavorsAttentionLine() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        MCCIMT000100UV01AttentionLine returnedToRequest = trans.copyNullFlavors(createMCCIMT000300UV01AttentionLineFromRequest(), 
    ...
    public void testCopyNullFlavorsAttentionLineEmpty() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        MCCIMT000100UV01AttentionLine returnedToRequest =trans.copyNullFlavors(createMCCIMT000300UV01AttentionLineFromRequestEmpty(), 
                createMCCIMT000100UV01AttentionLineToRequest());
    ...
    public void testCopyNullFlavorsDataEnterer() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        MFMIMT700701UV01DataEnterer returnedToRequest = trans.copyNullFlavors(createMFMIMT700711UV01DataEntererFromRequest(), 
                createMFMIMT700701UV01DataEntererToRequest());
        assertEquals(returnedToRequest.getNullFlavor().get(0), "NA");
        assertEquals(returnedToRequest.getNullFlavor().get(1), "NATest");
    ...
    public void testCopyNullFlavorsDataEntererEmpty() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        MFMIMT700701UV01DataEnterer returnedToRequest = trans.copyNullFlavors(createMFMIMT700711UV01DataEntererFromRequestEmpty(), 
                createMFMIMT700701UV01DataEntererToRequest());
    ...
    public void  testCopyNullFlavorsQUQIMT021001UV01DataEnterer() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        MFMIMT700701UV01DataEnterer returnedToRequest = trans.copyNullFlavors(createQUQIMT021001UV01DataEntererFromRequest(),
                createMFMIMT700701UV01DataEntererToRequest());
        assertEquals(returnedToRequest.getNullFlavor().get(0), "NA");
        assertEquals(returnedToRequest.getNullFlavor().get(1), "NATest");
    }
    ...
    public void  testCopyNullFlavorsQUQIMT021001UV01DataEntererEmpty() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        MFMIMT700701UV01DataEnterer returnedToRequest = trans.copyNullFlavors(createQUQIMT021001UV01DataEntererFromRequestEmpty(),
                createMFMIMT700701UV01DataEntererToRequest());
        assertEquals(returnedToRequest.getNullFlavor().get(0), "NADataEnterer");
    }
    ...
    public void testCopyNullFlavorsControlActProcess() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        PRPAIN201301UV02MFMIMT700701UV01ControlActProcess returnedToRequest = trans.copyNullFlavors(createPRPAIN201306UV02MFMIMT700711UV01ControlActProcess(), 
    ...
    public void testCopyNullFlavorsControlActProcessEmpty() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        PRPAIN201301UV02MFMIMT700701UV01ControlActProcess returnedToRequest = trans.copyNullFlavors(createPRPAIN201306UV02MFMIMT700711UV01ControlActProcessEmpty(),
                createPRPAIN201301UV02MFMIMT700701UV01ControlActProcess());
    ...
    public void testCopyNullFlavorsQUQIMT021001UV01ControlActProcess() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        PRPAIN201301UV02MFMIMT700701UV01ControlActProcess returnedToRequest = trans.copyNullFlavors(createPRPAIN201305UV02QUQIMT021001UV01ControlActProcess(), 
                createPRPAIN201301UV02MFMIMT700701UV01ControlActProcess());
        assertEquals(returnedToRequest.getNullFlavor().get(0), "NA");
        assertEquals(returnedToRequest.getNullFlavor().get(1), "NATest");       
    }
    ...
    public void testCopyNullFlavorsQUQIMT021001UV01ControlActProcessEmpty() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        PRPAIN201301UV02MFMIMT700701UV01ControlActProcess returnedToRequest = trans.copyNullFlavors(createPRPAIN201305UV02QUQIMT021001UV01ControlActProcessEmpty(), 
                createPRPAIN201301UV02MFMIMT700701UV01ControlActProcess());
        assertEquals(returnedToRequest.getNullFlavor().get(0), "NAControlActProcess");      
    }
    ...
    public void testCopyNullFlavorsMFMIMT700711UV01AuthorOrPerformer() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        MFMIMT700701UV01AuthorOrPerformer returnedToRequest = trans.copyNullFlavors(createMFMIMT700711UV01AuthorOrPerformer() , 
    ...
    public void testCopyNullFlavorsMFMIMT700711UV01AuthorOrPerformerEmpty() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        MFMIMT700701UV01AuthorOrPerformer returnedToRequest = trans.copyNullFlavors(createMFMIMT700711UV01AuthorOrPerformerEmpty(), 
                createMFMIMT700701UV01AuthorOrPerformer()) ;
    ...
    public void testCopyNullFlavorsAuthorOrPerformer() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        MFMIMT700701UV01AuthorOrPerformer returnedToRequest = trans.copyNullFlavors(createQUQIMT021001UV01AuthorOrPerformer(), 
                createMFMIMT700701UV01AuthorOrPerformer());
        assertEquals(returnedToRequest.getNullFlavor().get(0), "NA");
        assertEquals(returnedToRequest.getNullFlavor().get(1), "NATest");        
    }
    ...
    public void testCopyNullFlavorsAuthorOrPerformerEmpty() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        MFMIMT700701UV01AuthorOrPerformer returnedToRequest = trans.copyNullFlavors(createQUQIMT021001UV01AuthorOrPerformerEmpty(), 
                createMFMIMT700701UV01AuthorOrPerformer());
        assertEquals(returnedToRequest.getNullFlavor().get(0), "NAAuthorOrPerformer");
    }
    ...
    public void copyMCCIMT000100UV01AttentionLine() {
        ...
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        PRPAIN201301UV02 returnedToRequest = trans.copyMCCIMT000100UV01AttentionLine(createPRPAIN201306UV02WithAttentionLine(), 
                toRequest);
    ...
    public void copyMCCIMT000100UV01AttentionLinePRPAIN201305UV02() {
        PRPAIN201301UV02 toRequest = null;
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        PRPAIN201301UV02 returnedToRequest = trans.copyMCCIMT000100UV01AttentionLine(createPRPAIN201305UV02WithAttentionLine(), 
                toRequest);
        assertEquals(returnedToRequest.getAttentionLine().get(0).getNullFlavor().get(0), "NA");
        assertEquals(returnedToRequest.getAttentionLine().get(0).getNullFlavor().get(1), "NATest");
    }
    ...
    public void copyMCCIMT000100UV01Receiver() {
        PRPAIN201301UV02 toRequest = null;
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        PRPAIN201301UV02 returnedToRequest = trans.copyMCCIMT000100UV01Receiver(createPRPAIN201306UV02Receiver(), toRequest);
    ...
    public void copyMCCIMT000100UV01ReceiverWhenFromRequestReceiverNull() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        PRPAIN201301UV02 returnedToRequest = trans.copyMCCIMT000100UV01Receiver(createPRPAIN201306UV02(), createPRPAIN201301UV02Receiver());
    ...
    public void copyMCCIMT000100UV01PRPAIN201305UV02Receiver() {
        PRPAIN201301UV02 toRequest = null;
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        PRPAIN201301UV02 returnedToRequest = trans.copyMCCIMT000100UV01Receiver(createPRPAIN201305UV02ReceiverFromRequest(), 
                toRequest);
        assertEquals(returnedToRequest.getReceiver().get(0).getDevice().getId().get(0).getExtension(), "1.16.17.19");
    }
    ...
    public void copyRealmCodesAttentionLine() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        MCCIMT000100UV01AttentionLine returnedToRequest = trans.copyRealmCodes(createMCCIMT000300UV01AttentionLineFromRequest(), 
                createMCCIMT000100UV01AttentionLineToRequest());
        assertEquals(returnedToRequest.getRealmCode().get(0).getCode(), "CONNECT");
        assertEquals(returnedToRequest.getRealmCode().get(0).getCodeSystem(), "CONNECTDomain");
    }
    ...
    public void copyRealmCodesInformationRecipient() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        MFMIMT700701UV01InformationRecipient returnedToRequest = trans.copyRealmCodes(createMFMIMT700711UV01InformationRecipientFromRequest(), 
                createMFMIMT700701UV01InformationRecipientToRequest());
        assertEquals(returnedToRequest.getRealmCode().get(0).getCode(), "CONNECT");
        assertEquals(returnedToRequest.getRealmCode().get(0).getCodeSystem(), "CONNECTDomain");
    }
    ...
    public void copyRealmCodesAuthorOrPerformer() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        MFMIMT700701UV01AuthorOrPerformer returnedToRequest = trans.copyRealmCodes(createQUQIMT021001UV01AuthorOrPerformer(),
                createMFMIMT700701UV01AuthorOrPerformer());
        assertEquals(returnedToRequest.getRealmCode().get(0).getCode(), "CONNECT");
        assertEquals(returnedToRequest.getRealmCode().get(0).getCodeSystem(), "CONNECTDomain");
    }
    ...
    public void copyRealmCodesControlActProcess() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        PRPAIN201301UV02MFMIMT700701UV01ControlActProcess returnedToRequest = trans.copyRealmCodes(createPRPAIN201306UV02MFMIMT700711UV01ControlActProcess(),
                createPRPAIN201301UV02MFMIMT700701UV01ControlActProcess());
        assertEquals(returnedToRequest.getRealmCode().get(0).getCode(), "CONNECT");
        assertEquals(returnedToRequest.getRealmCode().get(0).getCodeSystem(), "CONNECTDomain");
    }
    ...
    public void copyTemplateIdsInformationRecipient() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        MFMIMT700701UV01InformationRecipient returnedToRequest = trans.copyTemplateIds(createMFMIMT700711UV01InformationRecipientFromRequest(),
                createMFMIMT700701UV01InformationRecipientToRequest());
    ...
    public void copyTemplateIdsAttentionLine() {
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        MCCIMT000100UV01AttentionLine returnedToRequest = trans.copyTemplateIds(createMCCIMT000300UV01AttentionLineFromRequest(),
                createMCCIMT000100UV01AttentionLineToRequest());
        assertEquals(returnedToRequest.getTemplateId().get(0).getExtension(), "D123401");
        assertEquals(returnedToRequest.getTemplateId().get(0).getRoot(), "1.1");
    ...
    public void copyIIsFromRequestNull() {
        ...
        HL7ArrayTransforms trans = new HL7ArrayTransforms();
        PRPAMT201301UV02Patient returnedToRequest = trans.copyIIs(fromRequest,
                createPRPAMT201301UV02PatientToRequest());
