 ...
 * 
 */
public class PatientDiscoveryRequestTransformsHCIDTest extends PatientDiscoveryTransformsBase {
    ...
    public void testGetPatientDiscoveryMessageCommunityIdPRPAIN201305UV02AdapterInbound() {
        // Setup Inputs
        PRPAIN201305UV02 message = Mockito.mock(PRPAIN201305UV02.class);
        ...
        String result = instance.getPatientDiscoveryMessageCommunityId(message, direction, _interface, type, process);
