 ...
 * @author Jon Hoppesch
 */
public class AdapterAuditQueryProxyObjectFactory {
    ...
    public AdapterAuditQueryProxy getAdapterAuditQueryProxy() {
        AdapterAuditQueryProxy adapterAuditQuery = null;
        if (context != null) {
            adapterAuditQuery = (AdapterAuditQueryProxy) context.getBean(BEAN_NAME_AUDIT_REPOSITORY);
        }
