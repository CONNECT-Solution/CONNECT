...
public class HL7PRPA201306Transforms
{
    ...
    public static PRPAIN201306UV createPRPA201306 (PRPAMT201301UVPatient patient, String senderOID, String receiverAAID, String receiverOID, String localDeviceId, PRPAIN201305UV query) {
    ...
    public static PRPAIN201306UVMFMIMT700711UV01ControlActProcess createQUQIMT021001UV01ControlActProcess (PRPAMT201301UVPatient patient, String localDeviceId, PRPAIN201305UV query, String aaId, String orgId) {
    ...
    public static MFMIMT700711UV01QueryAck createQueryAck(PRPAIN201305UV query) {
    ...
    private static PRPAIN201306UVMFMIMT700711UV01Subject1 createSubject(PRPAMT201301UVPatient patient, PRPAIN201305UV query, String patientId, String aaId, String orgId) {
    ...
    private static PRPAIN201306UVMFMIMT700711UV01RegistrationEvent createRegEvent(PRPAMT201301UVPatient patient, PRPAIN201305UV query, String patientId, String aaID, String orgId) {
   ...
   public static PRPAIN201306UVMFMIMT700711UV01Subject2 createSubject2(PRPAMT201301UVPatient patient, PRPAIN201305UV query, String patId, String orgId)
   {
        PRPAIN201306UVMFMIMT700711UV01Subject2 subject = new PRPAIN201306UVMFMIMT700711UV01Subject2();
        log.debug("patientID = " + patId);
        PRPAMT201310UVPatient pat310 = HL7PatientTransforms.create201310Patient(patient, patId, orgId);
        ...
        {
            log.debug("no ControlActProcess");
        }
    ...
    private static JAXBElement<COCTMT150003UV03Organization> createProviderOrg (PRPAMT201301UVPatient patient) {
   ...
   private static PRPAMT201310UVSubject createSubjectOf1 () {
    ...
    private static COCTMT090003UVAssignedEntity createAssignEntity (String oid) {
