 ...
 */
public class CORE_X12DSResponseAdapterExceptionBuilder implements AdapterCORE_X12DGenericBatchResponseProxy {

    private static final Logger LOG = Logger.getLogger(CORE_X12DSResponseAdapterExceptionBuilder.class);
