...
public class SamlCallbackHandler implements CallbackHandler {
    ...
    public SamlCallbackHandler() {
        System.out.println("SamlCallbackHandler Constructor -- Begin");
        try {
            initKeyStore();
            initTrustStore();
        } catch (IOException e) {
            System.out.println("SamlCallbackHandler Exception: " + e.getMessage());
            e.printStackTrace();
    ...
    public void handle(Callback[] callbacks) throws IOException, UnsupportedCallbackException {
        ...
        for (int i = 0; i < callbacks.length; i++) {
            if (callbacks[i] instanceof SAMLCallback) {
                ...
                System.out.println("=============== Print Runtime properties =============");
                tokenVals.putAll(samlCallback.getRuntimeProperties());
                System.out.println(tokenVals);
                System.out.println("=============== Completed Print properties =============");
    ...
    private Element createSVSAMLAssertion20() {
        System.out.println("SamlCallbackHandler.createSVSAMLAssertion20() -- Begin");
        ...
        try {
            ...
            System.out.println("createSVSAMLAssertion20 end ()");
    ...
    private Element createHOKSAMLAssertion20() {
        System.out.println("SamlCallbackHandler.createHOKSAMLAssertion20() -- Begin");
        Assertion assertion = null;
        try {
            SAMLAssertionFactory factory = SAMLAssertionFactory.newInstance(SAMLAssertionFactory.SAML2_0);
            ...
            assertion.setVersion("2.0");
            System.out.println("SamlCallbackHandler.createHOKSAMLAssertion20() -- End");
            return assertion.sign(pubKey, privKey);
        } catch (ParserConfigurationException ex) {
            System.out.println("Unable to create HOK Assertion: " + ex.getMessage());
            ex.printStackTrace();
    ...
    private NameID create509NameID(SAMLAssertionFactory factory, int assId) throws SAMLException {
        System.out.println("SamlCallbackHandler.createNameID() -- Begin " + assId);
        NameID nmId = null;
        ...
        if (assId != PRIMARY_NAME || !tokenVals.containsKey(USER_NAME_PROP)) {
            ...
            System.out.println("Create default X509 name: " + identifier);
        } else {
            ...
            try {
                ...
                System.out.println("Create X509 name: " + x509Name);
            } catch (IllegalArgumentException iae) {
                /* Could also test if email form if we wanted to support that */
                System.out.println("Set format as Unspecified. Invalid X509 format: " +
        ...
        System.out.println("SamlCallbackHandler.createNameID() -- End");
        return nmId;
    }

    /*public boolean isValidEmailAddress(String address) {
    System.out.println("SamlCallbackHandler.isValidEmailAddress() " + address + " -- Begin");
    ...
    System.out.println("Address does not follow the form 'local-part@domain'");
    }
    } catch (AddressException ex) {
    // address does not comply with RFC822
    System.out.println("Address is not of the RFC822 format");
    }
    }
    System.out.println("SamlCallbackHandler.isValidEmailAddress() " + retBool + " -- End");
    return retBool;
    }*/
    /**
    ...
    private List createAuthnStatements(SAMLAssertionFactory factory, GregorianCalendar issueInstant) throws SAMLException {
        System.out.println("SamlCallbackHandler.createAuthnStatements() -- Begin");
        ...
        System.out.println("Optional element SubjectLocality can not be determined: " + ex.getMessage());
        }*/
        ...
        if (tokenVals.containsKey(RESOURCE_PROP)) {
            System.out.println("Resource: " + tokenVals.get(RESOURCE_PROP));
        ...
        System.out.println("SamlCallbackHandler.createAuthnStatements() -- End");
        return statements;
    }
    ...
    private List addAssertStatements(SAMLAssertionFactory factory) throws SAMLException {
        ...
        System.out.println("SamlCallbackHandler.addAssertStatements() -- Begin");
        List statements = new ArrayList();
        ...
        if (tokenVals.containsKey(USER_ORG_PROP)) {
            ...
            System.out.println("No information provided to fill in user organization attribute");
        }
        ...
        try {
            ...
            if (tokenVals.containsKey(USER_CODE_PROP)) {
                System.out.println("User Role Code: " + tokenVals.get(USER_CODE_PROP));
                userRole.setAttribute("code", tokenVals.get(USER_CODE_PROP).toString());
            } else {
                System.out.println("No information provided to fill in user role code attribute");
            }
            if (tokenVals.containsKey(USER_SYST_PROP)) {
                System.out.println("User Role Code System: " + tokenVals.get(USER_SYST_PROP));
                userRole.setAttribute("codeSystem", tokenVals.get(USER_SYST_PROP).toString());
            } else {
                System.out.println("No information provided to fill in user role code system attribute");
            }
            if (tokenVals.containsKey(USER_SYST_NAME_PROP)) {
                System.out.println("User Role Code System Name: " + tokenVals.get(USER_SYST_NAME_PROP));
                userRole.setAttribute("codeSystemName", tokenVals.get(USER_SYST_NAME_PROP).toString());
            } else {
                System.out.println("No information provided to fill in user role code system name attribute");
            }
            if (tokenVals.containsKey(USER_DISPLAY_PROP)) {
                System.out.println("User Role Display: " + tokenVals.get(USER_DISPLAY_PROP));
                userRole.setAttribute("displayName", tokenVals.get(USER_DISPLAY_PROP).toString());
            } else {
                System.out.println("No information provided to fill in user role display attribute");
            }
            ...
            if (tokenVals.containsKey(PURPOSE_DISPLAY_PROP)) {
                System.out.println("Purpose Display: " + tokenVals.get(PURPOSE_DISPLAY_PROP));
            ...
            System.out.println("Unable to create an XML Document to set Attributes" + ex.getMessage());
        }
        System.out.println("SamlCallbackHandler.addAssertStatements() -- End");
        return statements;
    ...
    private Evidence createEvidence(SAMLAssertionFactory factory, GregorianCalendar issueInstant) throws SAMLException {
        System.out.println("SamlCallbackHandler.createEvidence() -- Begin");
        ...
        try {
            ...
            if (beginValidTime.after(endValidTime)) {
                ...
                System.out.println("The beginning time for the valid evidence should be before the ending time.  " +
            ...
            System.out.println("Unable to create Evidence Assertion: " + ex.getMessage());
        }
        Evidence evidence = factory.createEvidence(null, evAsserts);
        System.out.println("SamlCallbackHandler.createEvidence() -- End");
        return evidence;
    }
    ...
    private GregorianCalendar createCal(String time) {
        ...
        try {
            ...
            System.out.println("SamlCallbackHandler.createCal() Date: " + (cal.get(Calendar.MONTH) + 1) + "/" + cal.get(Calendar.DAY_OF_MONTH) + "/" + cal.get(Calendar.YEAR) + " " + cal.get(Calendar.HOUR_OF_DAY) + ":" + cal.get(Calendar.MINUTE) + ":" + cal.get(Calendar.SECOND));
        } catch (ParseException ex) {
            System.out.println(SamlCallbackHandler.class.getName() + "Date form is expected to be MM/dd/yyyy HH:mm:ss set default date");
        }
        return cal;
    }
    ...
    private List createEvidenceStatements(SAMLAssertionFactory factory) throws SAMLException {
        System.out.println("SamlCallbackHandler.createEvidenceStatements() -- Begin");
        List statements = new ArrayList();
        List attributes = new ArrayList();
        ...
        System.out.println("SamlCallbackHandler.createEvidenceStatements() -- End");
        return statements;
    }
    ...
    private void initKeyStore() throws IOException {
        System.out.println("SamlCallbackHandler.initKeyStore() -- Begin");
        InputStream is = null;
        ...
        if (storeLoc != null) {
            ...
            if (password != null) {
                try {
                    ...
                    System.out.println("Error initializing KeyStore: " + ex);
                ...
                System.out.println("SamlCallbackHandler.initKeyStore() -- End");
            } else {
    ...
    private void initTrustStore() throws IOException {
        System.out.println("SamlCallbackHandler.initTrustStore() -- Begin");
        InputStream is = null;
        ...
        if (storeLoc != null) {
            ...
            if (password != null) {
                try {
                    ...
                    System.out.println("Error initializing TrustStore: " + ex);
                    throw new IOException(ex.getMessage());
                } catch (CertificateException ex) {
                    System.out.println("Error initializing TrustStore: " + ex);
                    throw new IOException(ex.getMessage());
        ...
        System.out.println("SamlCallbackHandler.initTrustStore() -- End");
    }
    ...
    private void getDefaultPrivKeyCert(
            ...
            throws IOException {
        System.out.println("SamlCallbackHandler.getDefaultPrivKeyCert() -- Begin");
        ...
        if (client_key_alias != null) {
            ...
            if (password != null) {
                try {
                    ...
                    if (uniqueAlias != null) {
                        ...
                        System.out.println("Client key alais can not be determined");
                    }
                } catch (UnrecoverableKeyException ex) {
                    System.out.println("Error initializing Private Key: " + ex);
                    throw new IOException(ex.getMessage());
                } catch (NoSuchAlgorithmException ex) {
                    System.out.println("Error initializing Private Key: " + ex);
                    throw new IOException(ex.getMessage());
            ...
            System.out.println("CLIENT_KEY_ALIAS is not defined in domain.xml");
        }
        System.out.println("SamlCallbackHandler.getDefaultPrivKeyCert() -- End");
    }
