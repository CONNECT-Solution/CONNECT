 ...
 * @author Jon Hoppesch
 */
public class AuditQueryAdapterWebServiceProxy implements AuditQueryAdapterProxy {

    private static Log log = LogFactory.getLog(AuditQueryAdapterWebServiceProxy.class);
