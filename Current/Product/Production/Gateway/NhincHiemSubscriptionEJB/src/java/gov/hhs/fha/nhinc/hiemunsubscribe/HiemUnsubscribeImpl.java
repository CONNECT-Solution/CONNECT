...
//        }
    ...
    private void unsubscribeToChild(Unsubscribe parentUnsubscribe, SubscriptionItem childSubscriptionItem, AssertionType parentAssertion) throws UnableToDestroySubscriptionFault {
        try {
