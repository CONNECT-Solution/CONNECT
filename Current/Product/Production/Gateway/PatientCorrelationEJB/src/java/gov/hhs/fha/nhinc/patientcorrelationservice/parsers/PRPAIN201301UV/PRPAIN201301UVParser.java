...
public class PRPAIN201301UVParser {
     ...
     */
    public static PRPAMT201301UVPatient ParseHL7PatientPersonFrom201301Message(org.hl7.v3.PRPAIN201301UV message) {
        //assume one subject for now
        PRPAMT201301UVPatient patient = ParseHL7PatientFromMessage(message);
        //PRPAMT201301UVPerson patientPerson = ParseHL7PatientPersonFromHL7Patient(patient);
        return patient;
    }
    
    /**
     * This method returns patientPerson extracted from PRPAMT201301UVPatient using JAXB Element
     * @param patient of type PRPAMT201301UVPatient
     * @return PRPAMT201301UVPerson
     */
//    public static PRPAMT201301UVPerson ParseHL7PatientPersonFromHL7Patient(PRPAMT201301UVPatient patient) {
...
//    }
     ...
     */
    public static PRPAMT201301UVPatient ParseHL7PatientFromMessage(org.hl7.v3.PRPAIN201301UV message) {
        PRPAMT201301UVPatient patient = null;
        log.info("in ExtractPatient");

        PRPAIN201301UVMFMIMT700701UV01Subject1 subject = ParseSubjectFromMessage(message);
        if (subject == null) {
            return null;
        }
    ...
    public static PRPAIN201301UVMFMIMT700701UV01Subject1 ParseSubjectFromMessage(org.hl7.v3.PRPAIN201301UV message) {
        //assume one subject for now
