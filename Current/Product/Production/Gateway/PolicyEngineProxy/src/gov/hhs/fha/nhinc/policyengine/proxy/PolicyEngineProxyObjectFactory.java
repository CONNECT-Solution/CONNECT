 ...
 * <bean id="policyengine" class="gov.hhs.fha.nhinc.policyengine.proxy.PolicyEngineNoOpImpl"/>
 * the bean id is "policyengine" and an object of this type can be retrieved from
 * the application context by calling the getBean method like:
 * context.getBean("policyengine");. This returns an object that can be casted to
 * the appropriate interface and then used in the application code. See the
 * getPolicyEngineProxy() method in this class.
 *
 * @author Jon Hoppesch
 */
public class PolicyEngineProxyObjectFactory {
