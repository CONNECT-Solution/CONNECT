...
@WebService(serviceName = "AdapterPEP", portName = "AdapterPEPPortSoap11", endpointInterface = "gov.hhs.fha.nhinc.adapterpep.AdapterPEPPortType", targetNamespace = "urn:gov:hhs:fha:nhinc:adapterpep", wsdlLocation = "META-INF/wsdl/AdapterPEPService/AdapterPEP.wsdl")
@Stateless
public class AdapterPEPService implements AdapterPEPPortType {
